function [c, ceq]=ELONGATION_discrete(LinkPropertiesStruct, LatticeGeometryStruct, BehaviorStruct,FEMStruct,OptimizerDataStruct, discspaceidx,PossibleStiffnessArray)
